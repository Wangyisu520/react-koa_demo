                            ...
                            showActions ? (
                                <span>
                                    <button onClick={this.onLikeClick.bind(this, post._id)} type="button" className="btn btn-light mr-1">
                                        ...
                                        <i className={`fas fa-thumbs-up ${post.likes.length > 0? 'text-info' : ''}`}></i>
                                        {/* {
                                            this.state.iconFlag ? <i className='fas fa-thumbs-up text-info'></i> :<i className='fas fa-thumbs-up'></i>
                                        } */}
